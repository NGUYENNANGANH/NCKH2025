...
namespace BanHang.API.Migrations
{
    ...
    [Migration("20250417093021_AddTrangThaiSanPhamValueColumn")]
    partial class AddTrangThaiSanPhamValueColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BanHang.API.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("BanHang.API.Models.SanPham", b =>
                {
                    ...
                    b.Property<int>("TrangThaiSanPham_Value")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BanHang.API.Models.Voucher", b =>
                {
                    b.Property<string>("Id_Voucher")
                        .HasColumnType("nvarchar(450)");

                    b.Property<bool>("ApDungChoDonHangDauTien")
                        .HasColumnType("bit");

                    b.Property<bool>("ApDungChoTatCaSanPham")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BanHang.API.Models.VoucherDanhMuc", b =>
                {
                    b.Property<string>("Id_Voucher")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("Id_Voucher", "Id_DanhMuc");
            ...
            modelBuilder.Entity("BanHang.API.Models.VoucherSanPham", b =>
                {
                    b.Property<string>("Id_Voucher")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("Id_Voucher", "Id_SanPham");
            ...
            modelBuilder.Entity("BanHang.API.Models.VoucherSuDung", b =>
                {
                    b.Property<string>("Id_VoucherSuDung")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BanHang.API.Models.VoucherDanhMuc", b =>
                {
                    ...
                    b.HasOne("BanHang.API.Models.Voucher", "Voucher")
